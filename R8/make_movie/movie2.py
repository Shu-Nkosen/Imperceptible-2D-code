...
# ======= ユーザー設定（デフォルト値はここでまとめて変更可） ==========
DEFAULT_SELECTED_IMAGE = 4
DEFAULT_BRIGHTNESS_DECREASE = 2
DEFAULT_COLOR = "X"
DEFAULT_INTERVAL = 100

parser = argparse.ArgumentParser(description="Image flicker (Python, GLFW)")
parser.add_argument("--selected-image", type=int, default=DEFAULT_SELECTED_IMAGE,
                    help="0: hocho, 1: kosen, 2: nagaoka_fireworks, 3: rice, 4: ex")
parser.add_argument("--brightness-decrease", type=int, default=DEFAULT_BRIGHTNESS_DECREASE,
                    help="brightness decrease amount")
parser.add_argument("--color", type=str, default=DEFAULT_COLOR,
                    help="color token used in filename suffix")
parser.add_argument("--interval", type=int, default=DEFAULT_INTERVAL,
                    help="glfw swap interval")
...
BRIGHTNESS_DECREASE = args.brightness_decrease
COLOR = args.color
...
# 必要な3種類の画像ファイル名（Cと同じ命名規則）
normal_file = f"{selected_base_name}_{BRIGHTNESS_DECREASE}_normal{COLOR}.png"
inv_file = f"{selected_base_name}_{BRIGHTNESS_DECREASE}_inv{COLOR}.png"
