...
# ======= ユーザー設定 ==========
# 比較する2つの画像のパス
IMAGE1_PATH = "DSC_0000_BURST20251119160910215.JPG"  # 1フレーム目 DSC_0001_BURST20251119160923449
IMAGE2_PATH = "DSC_0001_BURST20251119160910215.JPG"  # 2フレーム目

IMAGE_PATTERN = "DSC_????_BURST20251119160910215.JPG"  # 対象ファイルパターン
THRESHOLD = 4/255
QUALITY_SCALE = 1
...
def build_pair_folder_name(path1: Path, path2: Path):
    ...
    return f"{idx1}-{idx2}-DSC_BURST{timestamp}"
